...
void straight()
{
        ...
        if(id==1)
           ...
           if(s==0)
           forward(4);
           glutPostRedisplay(); //overlay display callback to re-mark that window for redisplay.
}
...
void front()
{
        ...
        output(365,130,"B M S INSTITUE OF TECHNOLOGY AND MANAGEMENT",fonts[3]);
        ...
        output(225,450,"Raghavendra unki",fonts[3]);
        output(670,450,"Raahul N",fonts[3]);
        output(180,300,"",fonts[3]);
        output(220,400,"(1BY17CS127)",fonts[0]);
        output(680,400,"(1BY17CS126)",fonts[0]);
...
void help()
{
        ...
        glColor3f(0.5,0.2,0.6);
        output(600,60,"[ Dept. of CS&E, BMSIT ]",fonts[0]);
}
void intro()
{
        glColor3f(0.8,0.1,0.2);
